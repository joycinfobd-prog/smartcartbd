...
import { ShoppingBag, CheckCircle, Send, Phone, MapPin, Mail, Settings } from 'lucide-react';
...
export const Footer: React.FC<FooterProps> = ({ storeSettings, onOpenAdmin }) => {
  ...
  return (
    <footer id="contact" className="px-4 pb-12 pt-8 sm:px-8 max-w-7xl mx-auto">
      ...
      <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4 border-t border-slate-200 pt-10">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-xs font-medium text-slate-600">
            ...
            {onOpenAdmin && (
              <li>
                <button onClick={onOpenAdmin} className="text-slate-700 hover:text-emerald-600 font-bold flex items-center gap-1">
                  <Settings size={12} />
