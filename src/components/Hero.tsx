...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section id="home" className="px-4 py-8 sm:px-8 max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-12 gap-8 items-stretch">
        {/* Left Column: Hero Narrative & Key Points */}
        <div className="lg:col-span-7 flex flex-col justify-between py-2">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 border border-emerald-200 rounded-lg text-xs font-bold text-emerald-700 mb-6">
              <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
              <span>100% Genuine • Direct WhatsApp Checkout</span>
            </div>

            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-slate-800 tracking-tight leading-[1.12]">
              Smart Shopping with <span className="text-emerald-600">Geometric Balance</span> & Instant WhatsApp
            </h1>

            <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl font-medium">
          ...
          <div className="mt-10 pt-6 border-t border-slate-200 grid grid-cols-3 gap-4">
            <div className="border-l-2 border-slate-200 pl-3">
              <p className="text-xl sm:text-2xl font-black text-slate-800">45K+</p>
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Orders Sent</p>
            </div>
            <div className="border-l-2 border-emerald-600 pl-3">
              <p className="text-xl sm:text-2xl font-black text-emerald-600">100%</p>
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Cash on Delivery</p>
            </div>
            <div className="border-l-2 border-slate-200 pl-3">
              <p className="text-xl sm:text-2xl font-black text-slate-800">4.9 ★</p>
