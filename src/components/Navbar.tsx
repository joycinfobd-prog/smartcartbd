  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#f8fafc]/95 backdrop-blur-md pt-2.5 pb-2 border-b border-slate-200/60">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6">
        <div className="bg-white rounded-full border border-slate-200/90 shadow-sm px-2.5 sm:px-6 py-2 sm:py-2.5 flex items-center justify-between gap-1.5 sm:gap-4 transition-all">
          ...
          <a href="#home" className="flex items-center gap-2.5 group shrink-0">
            ...
            <div className="flex min-w-0 flex-col">
              <span className="text-base sm:text-xl font-black tracking-tight text-slate-900 font-sans flex items-center truncate">
          ...
          <div className="flex items-center gap-0.5 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 text-xs font-bold text-sky-700 hover:text-sky-800 bg-sky-50 hover:bg-sky-100 border border-sky-200 px-3.5 py-1.5 rounded-full transition cursor-pointer"
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1.5 text-xs font-bold text-emerald-700 hover:text-emerald-800 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 px-3.5 py-1.5 rounded-full transition cursor-pointer"
            >
            ...
            <button
              ...
              className="relative p-1.5 sm:p-2 rounded-full text-slate-600 hover:text-rose-600 hover:bg-slate-100 transition"
              aria-label="Wishlist"
            >
            ...
            {currentUser ? (
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 sm:px-4 py-1.5 rounded-full text-xs font-bold text-slate-800 bg-slate-50 hover:bg-slate-100 border border-slate-200/90 shadow-2xs transition cursor-pointer"
                aria-label="Sign In"
              >
            ...
            <button
              onClick={onOpenCart}
              className="relative p-1.5 sm:p-2 rounded-full text-slate-800 hover:bg-slate-100 transition cursor-pointer"
              aria-label="Cart"
            >
            ...
            <button
              ...
              className="lg:hidden p-1.5 sm:p-2 rounded-full text-slate-700 hover:bg-slate-100 transition"
        ...
        {/* Daraz-style mobile search bar: input + inline Search button */}
        <div className="mt-2 md:hidden">
          <form
            ...
            className="flex items-center gap-1.5 rounded-full border-[1.5px] border-emerald-500/70 bg-white py-1 pl-3 pr-1 shadow-xs"
          >
            ...
            <input
              ...
              placeholder="smart watch, headphones, sneakers…"
            ...
            <button
              type="submit"
              className="shrink-0 rounded-full bg-emerald-600 px-4 py-1.5 text-xs font-bold text-white transition hover:bg-emerald-700 active:scale-95 cursor-pointer"
            >
              Search
            </button>
          </form>
        ...
        <div className="lg:hidden bg-white border-b border-slate-200 px-4 py-4 space-y-3 animate-fadeIn mt-2">
          <nav className="flex flex-col space-y-2 text-sm font-bold text-slate-700">
            <button
              ...
              className="text-left px-3 py-2 rounded-xl bg-slate-100 text-slate-900"
            >
              Home
            </button>
            <a 
            ...
            <button
              ...
              className="text-left px-3 py-2 rounded-xl hover:bg-slate-50 flex items-center gap-2 text-sky-700 font-bold"
            >
              <Headphones size={15} />
